"""Login-Autostart der **Menüleisten-App** über einen LaunchAgent (In-App-Toggle).

Portiert aus iCloud-Sync. Schreibt/entfernt ein ``~/Library/LaunchAgents``-plist, das die
